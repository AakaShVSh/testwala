...
//  *
//  * Two views:
//  *  1. Coaching list   — filterable by status / exam type / city / search
//  *  2. Coaching detail — all coaching info + tests tab + students tab
//  *
//  * Features
//  * ─────────
//  * • Full coaching CRUD (approve / reject / deactivate / delete)
//  * • Tests per coaching — full stats, total students, submissions modal
//  * • "Coaching viewed test" notification via socket  coaching:test-viewed
//  * • Live socket:  coaching:new-request  → prepend to list
//  * • Filters: status, exam type, city, search
//  */
