...
// const STATUS_STYLE = {
//   pending:    { bg: "#fffbeb", color: "#d97706", label: "⏳ Pending",    border: "#fde68a" },
//   processing: { bg: "#eff6ff", color: "#2563eb", label: "🔄 Processing", border: "#bfdbfe" },
//   completed:  { bg: "#f0fdf4", color: "#16a34a", label: "✅ Completed",  border: "#bbf7d0" },
...
//           <Stack spacing={5}>
//             {/* Share */}
//             <Box bg="#f8fafc" borderRadius="14px" border="1px solid #e2e8f0" p={5}>
//               <Text fontSize="11px" fontWeight={800} color="#94a3b8"
//                 textTransform="uppercase" letterSpacing="2px" mb={3}>
//                 Share with Students
//               </Text>
//               <Box bg="white" borderRadius="10px" border="1px solid #e2e8f0"
//                 px={4} py="12px" fontFamily="monospace" fontSize="12px"
//                 color="#374151" mb={3} wordBreak="break-all">
//                 {shareUrl}
//               </Box>
//               <Flex gap={2} flexWrap="wrap">
//                 <Button size="sm" leftIcon={<FaLink />} onClick={copy}
//                   bg="#4a72b8" color="white" borderRadius="8px" fontWeight={700}>
//                   Copy Link
//                 </Button>
//                 <Button size="sm" leftIcon={<FaWhatsapp />} onClick={whatsapp}
//                   bg="#16a34a" color="white" borderRadius="8px" fontWeight={700}>
//                   WhatsApp
//                 </Button>
//                 <Button size="sm" leftIcon={<FaExternalLinkAlt />}
//                   onClick={() => window.open(shareUrl, "_blank")}
//                   variant="outline" borderRadius="8px" fontWeight={700} borderColor="#e2e8f0">
//                   Open Test
//                 </Button>
//               </Flex>
//             </Box>
...
//                 <Stack spacing={3}>
//                   {test.questions.map((q, i) => (
//                     <Box key={i} bg="#f8fafc" borderRadius="12px"
//                       border="1px solid #e2e8f0" overflow="hidden">
//                       <Flex px={4} py={3} align="center" gap={3} cursor="pointer"
//                         onClick={() => toggleQ(i)} _hover={{ bg: "#f0f7ff" }}
//                         transition="background .15s">
//                         <Flex w="24px" h="24px" flexShrink={0} bg="#e2e8f0"
//                           borderRadius="6px" align="center" justify="center"
//                           fontSize="11px" fontWeight={800} color="#64748b">
//                           {i + 1}
//                         </Flex>
//                         <Text flex={1} fontSize="13px" fontWeight={600} color="#0f172a"
//                           noOfLines={expanded[i] ? undefined : 2}>
//                           {q.qus}
//                         </Text>
//                         <Icon as={expanded[i] ? FaChevronUp : FaChevronDown}
...
//                           <Stack spacing={2} mt={2}>
//                             {q.options?.map((opt, oi) => (
//                               <Flex key={oi} align="center" gap={3}
//                                 bg={q.answer === oi ? "#f0fdf4" : "white"}
//                                 border="1px solid"
//                                 borderColor={q.answer === oi ? "#16a34a" : "#e2e8f0"}
//                                 borderRadius="8px" px={3} py="8px">
//                                 <Flex w="20px" h="20px" flexShrink={0}
//                                   bg={q.answer === oi ? "#dcfce7" : "#f1f5f9"}
//                                   borderRadius="5px" align="center" justify="center"
//                                   fontSize="10px" fontWeight={800}
//                                   color={q.answer === oi ? "#15803d" : "#64748b"}>
//                                   {OPTION_LABELS[oi]}
//                                 </Flex>
//                                 <Text fontSize="13px" flex={1}
//                                   color={q.answer === oi ? "#15803d" : "#374151"}
//                                   fontWeight={q.answer === oi ? 700 : 400}>
//                                   {opt}
//                                 </Text>
//                                 {q.answer === oi && (
...
//                           </Stack>
//                           {q.explanation && (
//                             <Box mt={3} bg="#fffbeb" border="1px solid #fde68a"
//                               borderRadius="8px" px={3} py="8px">
//                               <Text fontSize="11px" fontWeight={800} color="#d97706" mb={1}>
//                                 EXPLANATION
//                               </Text>
...
//           My Test Requests
//         </Text>
//         <Button size="sm" leftIcon={<FaPlus />} onClick={onRequestTest}
//           bg="#4a72b8" color="white" borderRadius="9px"
//           fontWeight={700} fontSize="12px" _hover={{ bg: "#3b5fa0" }}>
//           New Request
//         </Button>
//       </Flex>

//       {requests.length === 0 ? (
//         <Box py={14} textAlign="center" bg="white"
...
//             test and send it back.
//           </Text>
//           <Button leftIcon={<FaPaperPlane />} onClick={onRequestTest}
//             bg="#4a72b8" color="white" borderRadius="10px"
//             fontWeight={700} _hover={{ bg: "#3b5fa0" }}>
//             Submit Test Request
//           </Button>
//         </Box>
//       ) : (
...
//           <Flex px={6} py={3} bg="#f8fafc" borderBottom="1px solid #e2e8f0">
//             {[["Request Title", 3], ["Exam", 1], ["Questions", 1], ["Status", 1.5]].map(([h, f]) => (
//               <Text key={h} flex={f} fontSize="11px" fontWeight={700} color="#94a3b8"
...
//                 transition="background .15s" _hover={{ bg: "#f8faff" }}>
//                 <Box flex={3} minW={0}>
//                   <Text fontSize="14px" fontWeight={700} color="#0f172a" noOfLines={1}>
//                     {req.title}
//                   </Text>
//                   <Text fontSize="11px" color="#94a3b8" mt="1px">
//                     {new Date(req.createdAt).toLocaleDateString("en-IN", {
...
//                     bg={s.bg} color={s.color} border={`1px solid ${s.border}`}
//                     px={3} py="3px" borderRadius="full" fontSize="11px" fontWeight={700}>
//                     {s.label}
//                   </Box>
//                 </Box>
...
//                 <Flex w="110px" justify="flex-end" gap={2}>
//                   {req.status === "completed" && req.createdTestId && (
//                     <Button size="xs" leftIcon={<FaEye />} onClick={() => openTest(req)}
//                       bg="#4a72b8" color="white" borderRadius="7px"
//                       fontWeight={700} fontSize="11px" _hover={{ bg: "#3b5fa0" }}>
//                       View Test
//                     </Button>
//                   )}
//                   {req.status === "processing" && (
//                     <Flex align="center" gap={1}>
//                       <Spinner size="xs" color="#2563eb" />
//                       <Text fontSize="10px" color="#2563eb" fontWeight={600}>Working…</Text>
//                     </Flex>
//                   )}
//                 </Flex>
//               </Flex>
...
//     for (const file of picked) {
//       if (file.size > MAX) {
//         toast({ title: `${file.name} exceeds 10 MB — skipped`, status: "warning", duration: 3000 });
//         continue;
//       }
//       const type = detectFileType(file);
//       const base64 = await toBase64(file);
//       result.push({ name: file.name, type, base64, size: file.size, mimeType: file.type });
//     }
//     setFiles((p) => [...p, ...result]);
//   };
...
//     mb: 1, textTransform: "uppercase", letterSpacing: ".8px",
//   };
//   const IS = {
//     borderRadius: "10px", h: "44px", fontSize: "14px", borderColor: "#e2e8f0",
//     _focus: { borderColor: "#4a72b8", boxShadow: "0 0 0 1px #4a72b8" },
//   };
...
//     <Drawer isOpen={isOpen} onClose={handleClose} placement="right" size="lg">
//       <DrawerOverlay backdropFilter="blur(4px)" bg="rgba(0,0,0,.45)" />
//       <DrawerContent borderLeftRadius="20px" overflow="hidden" fontFamily="'Sora',sans-serif">
//         <DrawerCloseButton top={4} right={4} zIndex={10} color="white" />
//         <DrawerHeader px={7} pt={7} pb={5}
//           bg="linear-gradient(135deg,#0f1e3a,#2d5fa8)" color="white">
//           <Flex align="center" gap={3}>
//             <Flex w="42px" h="42px" bg="rgba(255,255,255,.15)"
//               borderRadius="12px" align="center" justify="center">
//               <Icon as={FaPaperPlane} fontSize="18px" />
//             </Flex>
//             <Box>
//               <Text fontSize="18px" fontWeight={800} lineHeight="1.2">Request a Test</Text>
//               <Text fontSize="12px" color="rgba(255,255,255,.6)" mt="2px">
//                 Upload your content · Admin will build the test for you
//               </Text>
//             </Box>
...
//         <DrawerBody px={7} py={6} overflowY="auto">
//           <Stack spacing={5}>
//             <Box bg="#eff6ff" border="1px solid #bfdbfe" borderRadius="12px" p={4}>
//               <Text fontSize="12px" color="#1e40af" lineHeight={1.8}>
//                 📎 <strong>How it works:</strong> Fill in the details and attach
//                 any reference material (PDFs, screenshots, notes, Excel files).
//                 Admin will review them, create the test, and send it directly to
...
//                 placeholder="e.g. SSC CGL Mock — Reasoning + GA"
//                 {...IS} borderColor={errs.title ? "red.400" : "#e2e8f0"} />
//               <FormErrorMessage>{errs.title}</FormErrorMessage>
//             </FormControl>
...
//               <FormControl flex={1}>
//                 <FormLabel {...LS}>Subject</FormLabel>
//                 <Select value={form.subject} onChange={sf("subject")}
//                   borderRadius="10px" h="44px" fontSize="14px" borderColor="#e2e8f0">
//                   <option value="">Any / Mixed</option>
//                   {SUBJECTS.map((s) => (
//                     <option key={s} value={s}>
...
//                   onChange={sf("totalQuestions")} min={5} max={200} {...IS} />
//               </FormControl>
//               <FormControl flex={1}>
//                 <FormLabel {...LS}>Time Limit (min)</FormLabel>
//                 <Input type="number" value={form.timeLimitMin}
//                   onChange={sf("timeLimitMin")} min={5} max={180} {...IS} />
//               </FormControl>
//             </Flex>
...
//               <FormControl flex={1}>
//                 <FormLabel {...LS}>Difficulty</FormLabel>
//                 <Select value={form.difficulty} onChange={sf("difficulty")}
//                   borderRadius="10px" h="44px" fontSize="14px" borderColor="#e2e8f0">
//                   <option value="easy">Easy</option>
//                   <option value="medium">Medium</option>
//                   <option value="hard">Hard</option>
...
//               <FormControl flex={1}>
//                 <FormLabel {...LS}>Test Access</FormLabel>
//                 <Select value={form.visibility} onChange={sf("visibility")}
//                   borderRadius="10px" h="44px" fontSize="14px" borderColor="#e2e8f0">
//                   <option value="public">🌐 Public</option>
//                   <option value="private">🔒 Private</option>
//                 </Select>
...
//               <FormLabel {...LS}>
//                 Instructions for Admin{" "}
//                 <Text as="span" color="#94a3b8" textTransform="none" fontWeight={400}>
//                   (optional)
//                 </Text>
//               </FormLabel>
//               <Textarea value={form.instructions} onChange={sf("instructions")}
//                 placeholder="Topics to cover, question style, syllabus focus, difficulty split…"
//                 borderRadius="10px" fontSize="14px" rows={3} resize="vertical"
//                 borderColor="#e2e8f0"
//                 _focus={{ borderColor: "#4a72b8", boxShadow: "0 0 0 1px #4a72b8" }} />
//             </FormControl>
...
//             <Box>
//               <Flex justify="space-between" align="center" mb={1}>
//                 <Text {...LS} mb={0}>Attach Reference Files</Text>
...
//               <Box border="2px dashed"
//                 borderColor={files.length ? "#4a72b8" : "#e2e8f0"}
//                 borderRadius="14px" p={6} textAlign="center" cursor="pointer"
//                 bg={files.length ? "#f0f7ff" : "#f8fafc"}
//                 onClick={() => fileRef.current?.click()}
//                 transition="all .2s" _hover={{ borderColor: "#4a72b8", bg: "#f0f7ff" }}>
//                 <Icon as={FaUpload} fontSize="30px" color="#94a3b8"
//                   display="block" mx="auto" mb={2} />
//                 <Text fontSize="14px" fontWeight={600} color="#374151">
//                   Click to attach files
//                 </Text>
//                 <Text fontSize="12px" color="#94a3b8" mt={1}>
...
//                 <Stack mt={3} spacing={2}>
//                   {files.map((f, i) => (
//                     <Flex key={i} align="center" gap={3} bg="white"
//                       borderRadius="10px" border="1px solid #e2e8f0" p={3}>
//                       <FileIcon type={f.type} />
//                       <Box flex={1} minW={0}>
//                         <Text fontSize="12px" fontWeight={600} color="#0f172a" noOfLines={1}>
//                           {f.name}
//                         </Text>
//                         <Text fontSize="10px" color="#94a3b8">
...
//                         </Box>
//                       )}
//                       <Box as="button" onClick={() => removeFile(i)} p={2}
//                         borderRadius="6px" color="#ef4444" _hover={{ bg: "#fef2f2" }}>
//                         <Icon as={FaTrash} fontSize="11px" />
//                       </Box>
//                     </Flex>
//                   ))}
//                   <Button size="xs" leftIcon={<FaPlus />} variant="ghost"
//                     color="#4a72b8" fontWeight={700} alignSelf="flex-start"
//                     onClick={() => fileRef.current?.click()}>
//                     Add More Files
//                   </Button>
//                 </Stack>
...
//             <Button h="50px" borderRadius="12px" mt={2}
//               bg="linear-gradient(135deg,#4a72b8,#1e3a5f)"
//               color="white" fontWeight={800} fontSize="14px"
//               isLoading={busy} loadingText="Submitting…"
//               onClick={handleSubmit} leftIcon={<FaPaperPlane />}
//               _hover={{ opacity: 0.9, transform: "translateY(-1px)", boxShadow: "0 8px 24px rgba(74,114,184,.35)" }}
//               transition="all .2s">
//               Submit Request to Admin
//             </Button>
//           </Stack>
...
//   const { isOpen: testOpen, onOpen: openTest, onClose: closeTest } = useDisclosure();
...
//           status: "success", duration: 8000, isClosable: true, position: "top-right" });
//       } else if (notification.type === "request_processing") {
//         toast({ title: notification.title, status: "info",
...
//         onClick={() => { openDrawer(); loadNotifications(); }}>
//         <Flex w="38px" h="38px" align="center" justify="center"
//           borderRadius="10px" bg="#f8fafc" border="1px solid #e2e8f0"
//           _hover={{ bg: "#f1f5f9" }} transition="all .15s">
//           <Icon as={FaBell} fontSize="15px" color="#475569" />
//         </Flex>
//         {unread > 0 && (
//           <Flex position="absolute" top="-6px" right="-6px" minW="18px" h="18px"
//             bg="#ef4444" borderRadius="full" align="center" justify="center"
//             px={1} border="2px solid white">
//             <Text fontSize="9px" fontWeight={800} color="white" lineHeight="1">
//               {unread > 9 ? "9+" : unread}
//             </Text>
//           </Flex>
...
//       <Drawer isOpen={drawerOpen} onClose={closeDrawer} placement="right" size="sm">
//         <DrawerOverlay backdropFilter="blur(2px)" bg="rgba(0,0,0,.3)" />
//         <DrawerContent fontFamily="'Sora',sans-serif">
//           <DrawerCloseButton top={4} right={4} />
//           <DrawerHeader px={6} pt={6} pb={4} borderBottom="1px solid #f1f5f9">
//             <Flex align="center" justify="space-between" pr={8}>
//               <Box>
//                 <Text fontSize="16px" fontWeight={800} color="#0f172a">Notifications</Text>
//                 {unread > 0 && (
//                   <Text fontSize="12px" color="#64748b" mt="1px">{unread} unread</Text>
//                 )}
//               </Box>
//               {unread > 0 && (
//                 <Button size="xs" variant="ghost" fontSize="11px" color="#4a72b8"
//                   fontWeight={700} onClick={markAllRead} borderRadius="7px"
//                   _hover={{ bg: "#eff6ff" }}>
//                   Mark all read
//                 </Button>
//               )}
...
//           <DrawerBody px={0} py={0} overflowY="auto">
//             {loading ? (
//               <Flex justify="center" py={10}><Spinner color="#4a72b8" /></Flex>
//             ) : notifications.length === 0 ? (
//               <Flex direction="column" align="center" py={16} px={6} gap={3}>
//                 <Flex w="56px" h="56px" bg="#f1f5f9" borderRadius="full"
...
//                   const isTestReady = n.type === "test_ready" && n.testId;
//                   return (
//                     <Flex key={n._id} px={5} py={4} gap={3}
//                       bg={n.isRead ? "white" : "#f8faff"}
//                       borderBottom="1px solid #f1f5f9"
//                       borderLeft={n.isRead ? "3px solid transparent" : "3px solid #4a72b8"}
//                       cursor={isTestReady ? "pointer" : "default"}
//                       onClick={() => handleNotifClick(n)}
//                       _hover={{ bg: isTestReady ? "#f0f7ff" : n.isRead ? "white" : "#f8faff" }}
//                       transition="background .15s" align="flex-start">
//                       <Flex w="36px" h="36px" flexShrink={0} borderRadius="10px"
//                         bg={ic.bg} align="center" justify="center">
//                         <Icon as={ic.icon} color={ic.color} fontSize="14px" />
//                       </Flex>
//                       <Box flex={1} minW={0}>
//                         <Flex align="flex-start" justify="space-between" gap={2} mb={1}>
//                           <Text fontSize="13px" fontWeight={n.isRead ? 600 : 800}
//                             color="#0f172a" lineHeight={1.4}>
//                             {n.title}
//                           </Text>
//                           {!n.isRead && (
//                             <Box w="7px" h="7px" bg="#4a72b8" borderRadius="full"
//                               flexShrink={0} mt="4px" />
//                           )}
//                         </Flex>
//                         {n.body && (
...
//                           </Text>
//                           {isTestReady && (
//                             <Flex align="center" gap={1} bg="#eff6ff" color="#2563eb"
...
// ── Section row editor ─────────────────────────────────────────────────────
function SectionRow({ section, index, onChange, onDelete, canDelete }) {
  return (
    <Box bg="white" borderRadius="10px" border="1px solid #e2e8f0" p={4} mb={3}>
      ...
      <Flex gap={3} direction={{ base: "column", sm: "row" }}>
        <FormControl flex={1}>
          ...
          <Select
            ...
            onChange={(e) =>
              onChange(index, { ...section, subject: e.target.value })
            }
            borderRadius="8px"
            h="40px"
            fontSize="13px"
        ...
        <FormControl flex={1}>
          ...
          <Input
            ...
            onChange={(e) =>
              onChange(index, {
                ...section,
                totalQuestions: Number(e.target.value) || 10,
              })
            }
            min={1}
            max={100}
...
function TestDetailModal({ test, isOpen, onClose }) {
  ...
  // For sectioned tests, flatten all questions for display
  const allQuestions =
    test.isSectioned && test.sections?.length
      ...
      >
        ...
        >
          ...
          <Flex gap={4} mt={2} flexWrap="wrap">
            {[
              ...
              [
                "❓",
                `${test.totalMarks || allQuestions.length || 0} questions`,
              ],
              ["🔐", test.visibility === "private" ? "Private" : "Public"],
              ...(test.isSectioned
        ...
        <ModalBody px={7} py={6}>
          <Stack spacing={5}>
            ...
            {/* Sectioned breakdown */}
            {test.isSectioned && test.sections?.length > 0 && (
              <Box>
                <Text
                  fontSize="11px"
                  fontWeight={800}
...
export default function RequestTestDrawer({
  ...
  const coachingStandard = coachingExamTypes.filter((t) =>
    STANDARD_EXAM_TYPES.includes(t),
  );
  const coachingCustom = coachingExamTypes.filter(
    (t) => !STANDARD_EXAM_TYPES.includes(t),
  );
  const otherStandard = STANDARD_EXAM_TYPES.filter(
    (t) => !coachingExamTypes.includes(t),
  );

  // ── Sectioned state ────────────────────────────────────────────────────────
  const [isSectioned, setIsSectioned] = useState(false);
  const [sections, setSections] = useState([
    { subject: "", totalQuestions: 10 },
    { subject: "", totalQuestions: 10 },
  ]);
  ...
  const addSection = () =>
    setSections((p) => [...p, { subject: "", totalQuestions: 10 }]);

  const updateSection = (idx, updated) =>
    setSections((p) => p.map((s, i) => (i === idx ? updated : s)));

  const deleteSection = (idx) =>
    setSections((p) => p.filter((_, i) => i !== idx));

  const computedTotal = isSectioned
    ? sections.reduce((sum, s) => sum + (s.totalQuestions || 0), 0)
    : Number(form.totalQuestions) || 20;
  ...
  const handleSubmit = async () => {
    ...
    if (form.selectedExam === "OTHER" && !customInput.trim())
      e.selectedExam = "Please specify the exam type";
    if (isSectioned) {
      const hasEmpty = sections.some((s) => !s.subject);
      if (hasEmpty) e.sections = "Each section must have a subject selected";
      if (sections.length < 2) e.sections = "Add at least 2 sections";
    }
    if (Object.keys(e).length) {
      setErrs(e);
      return;
    ...
    try {
      ...
      if (isSectioned) {
        body.isSectioned = true;
        body.sections = sections.map((s) => ({
          subject: s.subject,
          totalQuestions: Number(s.totalQuestions) || 10,
        }));
      } else {
        body.subject = form.subject || undefined;
        body.totalQuestions = Number(form.totalQuestions) || 20;
      }
        ...
        <DrawerBody px={7} py={6} overflowY="auto">
          <Stack spacing={5}>
            ...
            >
              <Text fontSize="12px" color="#1e40af" lineHeight={1.8}>
                📎 <strong>How it works:</strong> Fill in the details and attach
                any reference material. Admin will review them, create the test,
                and send it directly to your coaching.
              </Text>
            </Box>
              ...
              <Flex align="center" justify="space-between">
                <Box>
                  ...
                  <Text fontSize="11px" color="#64748b" mt="2px">
                    Split the test into sections by subject (e.g. English +
                    Reasoning)
                  </Text>
                </Box>
                <Switch
                  isChecked={isSectioned}
                  onChange={(e) => {
                    setIsSectioned(e.target.checked);
                    setErrs((p) => ({ ...p, sections: "" }));
                  }}
                  colorScheme="blue"
                  size="md"
                />
            ...
            {!isSectioned ? (
              ...
              <FormControl isInvalid={!!errs.sections}>
                <FormLabel {...LS}>
                  Sections
                  <Text
                    as="span"
                ...
                <FormErrorMessage>{errs.sections}</FormErrorMessage>
              </FormControl>
            )}
...
// ═══════════════════════════════════════════════════════════════
// NotificationBell — unchanged, re-exported as-is
// ═══════════════════════════════════════════════════════════════
export function NotificationBell() {
  const { user } = useAuth();
  const toast = useToast();
