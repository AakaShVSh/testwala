...
//   FaUser, FaRedoAlt, FaCalendarAlt,
// } from "react-icons/fa";
// import { FiAlertCircle, FiTarget, FiAward } from "react-icons/fi";
...
// // ─── All Attempts Panel (owner view only) ────────────────────────────────────
...
//           correctQus:       Array.isArray(r.correctQus)                    ? r.correctQus       : [],
//           wrongansqus:      Array.isArray(r.wrongansqus)  ? r.wrongansqus  : Array.isArray(r.wrongQus) ? r.wrongQus : [],
//           answeredQuestion: Array.isArray(r.answeredQuestion) ? r.answeredQuestion : Array.isArray(r.answeredQus) ? r.answeredQus : Array.isArray(r.answered) ? r.answered : [],
//           notAnswer:        Array.isArray(r.notAnswer)    ? r.notAnswer    : Array.isArray(r.notAnsweredQus) ? r.notAnsweredQus : Array.isArray(r.skipped) ? r.skipped : [],
//           markedAndAnswer:  Array.isArray(r.markedAndAnswer)  ? r.markedAndAnswer  : Array.isArray(r.markedAndAnswered)  ? r.markedAndAnswered  : [],
//           markedNotAnswer:  Array.isArray(r.markedNotAnswer)  ? r.markedNotAnswer  : Array.isArray(r.markedNotAnswered)  ? r.markedNotAnswered  : [],
//         },
//       });
//     } catch {
...
//       <Flex px={5} py={4} align="center" gap={3} borderBottom="1px solid #f1f5f9" flexWrap="wrap">
//         <Flex w="34px" h="34px" bg="#eff6ff" borderRadius="9px" align="center" justify="center" flexShrink={0}>
//           <Icon as={FaRedoAlt} color="#2563eb" fontSize="14px" />
//         </Flex>
//         <Box>
//           <Text fontSize="14px" fontWeight={800} color="#0f172a">All Attempts</Text>
//           <Text fontSize="11px" color="#94a3b8" mt="1px">{attempts.length} attempt{attempts.length !== 1 ? "s" : ""} · click any row to view that result</Text>
//         </Box>
//         {/* First-attempt badge */}
//         <Box ml="auto" bg="#fefce8" border="1px solid #fde68a" px={3} py="4px" borderRadius="full">
//           <Text fontSize="11px" fontWeight={700} color="#92400e">⭐ 1st attempt shown in leaderboard</Text>
//         </Box>
//       </Flex>
...
//           ? new Date(attempt.createdAt).toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit" })
//           : null;
...
//             borderBottom={idx < attempts.length - 1 ? "1px solid #f1f5f9" : "none"}
//             bg={isCurrent ? "#eff6ff" : "white"}
...
//           >
//             {/* Attempt number */}
//             <Flex w="32px" h="32px" borderRadius="8px" bg={isCurrent ? "#2563eb" : isFirst ? "#fefce8" : "#f8fafc"} border="1px solid" borderColor={isCurrent ? "#2563eb" : isFirst ? "#fde68a" : "#e2e8f0"} align="center" justify="center" flexShrink={0}>
//               <Text fontSize="11px" fontWeight={800} color={isCurrent ? "white" : isFirst ? "#92400e" : "#64748b"}>
//                 {idx + 1}
//               </Text>
//             </Flex>
...
//             {/* Score */}
//             <Box minW="60px">
//               <Text fontSize="18px" fontWeight={800} color={pctColor(pct)} lineHeight="1">{pct.toFixed(0)}%</Text>
//               <Text fontSize="10px" color="#94a3b8">{fmtTime(attempt.timeTakenSec ?? attempt.timeTaken ?? 0)}</Text>
//             </Box>

//             {/* Progress bar */}
//             <Box flex={1} minW={0}>
//               <Progress value={pct} size="sm" colorScheme={pct >= 60 ? "green" : pct >= 40 ? "yellow" : "red"} borderRadius="full" />
//             </Box>
...
//               {isFirst && <Badge bg="#fefce8" color="#92400e" border="1px solid #fde68a" fontSize="9px" fontWeight={700} px={2} py={0.5} borderRadius="full">Leaderboard</Badge>}
//               {isCurrent && <Badge bg="#eff6ff" color="#2563eb" border="1px solid #bfdbfe" fontSize="9px" fontWeight={700} px={2} py={0.5} borderRadius="full">Viewing</Badge>}
//               {isLoading && <Spinner size="xs" color="#4a72b8" />}
//             </Flex>
//           </Flex>
//         );
//       })}
...
//             </Flex>
//             <Box ml="auto" cursor="pointer" onClick={() => navigate(-1)} color="rgba(255,255,255,.45)" _hover={{ color: "white" }} transition="color .15s">
//               <Flex align="center" gap={1.5}>
...
//         <Flex maxW="1200px" mx="auto" align="center" justify="space-between">
//           <Flex align="center" gap={3}>
//             <Box cursor="pointer" onClick={() => navigate(isOwnerView ? -1 : "/")} color="rgba(255,255,255,.5)" _hover={{ color: "white" }}>
//               <Icon as={FaArrowLeft} fontSize="14px" />
//             </Box>
//             <Box>
//               <Text fontSize={{ base: "15px", md: "18px" }} fontWeight={800} color="white" noOfLines={1}>{testTitle}</Text>
...
//         <Flex justify="center" gap={4} mt={6} flexWrap="wrap">
//           {isOwnerView ? (
//             <Box as="button" px={6} py={3} bg="#0f1e3a" color="white" borderRadius="12px" fontWeight={700} fontSize="13px" onClick={() => navigate(-1)} _hover={{ opacity: .9 }} transition="opacity .2s">
//               ← Back to Leaderboard
//             </Box>
//           ) : (
//             <>
